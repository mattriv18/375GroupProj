...
int main(int argc, char* argv[])
{
	...
	for(int i = 5; i <= 500; i++){
		cout << "===================================\n";
		if (i == 10 || i == 17 || i == 27 || i == 38 || i == 43 || i == 45 || i == 67 || i == 84 || i == 85 || i == 132 || i == 134 || i == 156 || i == 165 || i == 175 || i == 185 || i == 188 || i == 193 || i == 194 || i == 242 || i == 257 || i == 297 || i == 299 || i == 312 || i == 354 || i == 377 || i == 390 || i == 439 || i == 446 || i == 457 || i == 481) {
			continue;
		}
		v = i;
